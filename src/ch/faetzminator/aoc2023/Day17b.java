...
public class Day17b {
    ...
    private long calculateLeastHeatLoss() {
        ...
        while (!queue.isEmpty()) {
            ...
            for (final Direction nextDirection : direction.getPossibleDirections(length >= MIN_LENGTH,
                    length < MAX_LENGTH)) {
    ...
    private static enum Direction {
        ...
        public Set<Direction> getPossibleDirections(final boolean inclOthers, final boolean inclOwn) {
            if (!inclOthers) {
                return inclOwn ? Set.of(this) : Set.of();
            }
